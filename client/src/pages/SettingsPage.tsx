...
import { getSettings, updateSettings, type DealerSettings } from '@/api/settings'
...
type ToneOption = 'professional' | 'neighborly'
...
function getSampleResponse(tone: ToneOption, dealerName: string): string {
  const responses: Record<ToneOption, string> = {
    professional: `Thank you for your feedback about your visit to ${dealerName}. We're committed to providing excellent service, and we appreciate you letting us know about your experience. Please don't hesitate to reach out if there's anything more we can do.`,
    neighborly: `Thanks so much for sharing your experience with us at ${dealerName}! We really appreciate you taking the time — it means a lot to our team. If there's anything else we can help with, just give us a call. We're always here for you!`,
  }
  return responses[tone]
}

export function SettingsPage({ dealer, onLogout }: SettingsPageProps) {
  ...
  const sampleResponse = getSampleResponse(settings.responseTone as ToneOption, dealer.name)
    ...
    >
      <div className="max-w-2xl space-y-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-gray-600 mb-6">
            Customize how AI-generated responses sound for {dealer.name}.
          </p>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <select
                  value={useCustomTitle ? '__custom__' : (settings.signOffTitle || 'General Manager')}
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    "Service took longer than expected, had to wait almost 3 hours for an oil change..."
                  </p>
                </div>
              </div>
